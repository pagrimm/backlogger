...
namespace backlogger.Migrations
{
    ...
    [Migration("20201008030657_RemovePriorityModels")]
    partial class RemovePriorityModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backlogger.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Backlogger.Models.Item", b =>
                {
            ...
            modelBuilder.Entity("Backlogger.Models.ItemUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Backlogger.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
